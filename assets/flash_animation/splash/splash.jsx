...
function PinMark() {
  return (
    <div className="fn-pin">
      <svg width="106" height="132" viewBox="0 0 120 150" fill="none">
        <path
          d="M60 4
             C34 4 14 24 14 50
             C14 80 44 112 56 140
             C58 144 62 144 64 140
             C76 112 106 80 106 50
             C106 24 86 4 60 4 Z"
          fill="var(--fn-pin)"
        />
        <circle cx="60" cy="50" r="17" fill="#fff" />
      </svg>
    </div>
  );
}
...
function Stage({ runId, t }) {
  ...
  useEffect(() => {
    ...
    const id = requestAnimationFrame(() =>
      requestAnimationFrame(() => el.classList.add("fn-play"))
    );
