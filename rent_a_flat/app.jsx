    ...
    <>
      <DesignCanvas>
        ...
        <DCSection id="owner" title="Owner" subtitle="Manage listings + post new ones">
          ...
          <DCArtboard id="post-location" label="Post · Location step · cascading" width={390} height={780}>
            <FNArtboard t={t} dark={t.dark}><FNCreateListing t={t} onBack={() => {}} initialStep={2} /></FNArtboard>
          </DCArtboard>
        </DCSection>
