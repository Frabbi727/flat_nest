...
class RegisterStep1View extends GetView<RegisterController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final isGoogle = controller.isGoogleUser.value;
      return RegChrome(
        t: t,
        step: 0,
        onBack: controller.goBack,
        title: isGoogle ? 'Complete your profile' : 'Create your account',
        subtitle: isGoogle
        ...
        child: Obx(() {
          ...
          return Column(
            ...
            children: [
              ...
              _ContinueButton(
                t: t,
                enabled: isGoogle ? controller.googleBasicValid : controller.step1Valid,
                loading: controller.isLoading,
                onTap: isGoogle ? controller.submitGoogleBasicInfo : controller.submitStep1,
              ),
              const SizedBox(height: 12),
